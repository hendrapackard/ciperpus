...
-- Dumping database structure for ciperpus
CREATE DATABASE IF NOT EXISTS `ciperpus` /*!40100 DEFAULT CHARACTER SET latin1 */;
USE `ciperpus`;


-- Dumping structure for table ciperpus.buku
...
-- Dumping data for table ciperpus.buku: ~43 rows (approximately)
DELETE FROM `buku`;
...
-- Dumping structure for table ciperpus.denda
...
-- Dumping data for table ciperpus.denda: ~0 rows (approximately)
DELETE FROM `denda`;
...
-- Dumping structure for table ciperpus.judul
...
-- Dumping data for table ciperpus.judul: ~41 rows (approximately)
DELETE FROM `judul`;
...
-- Dumping structure for table ciperpus.kelas
...
-- Dumping data for table ciperpus.kelas: ~6 rows (approximately)
DELETE FROM `kelas`;
...
-- Dumping structure for table ciperpus.peminjaman
...
-- Dumping data for table ciperpus.peminjaman: ~4 rows (approximately)
...
-- Dumping structure for table ciperpus.siswa
...
-- Dumping data for table ciperpus.siswa: ~125 rows (approximately)
DELETE FROM `siswa`;
...
-- Dumping structure for table ciperpus.user
...
-- Dumping data for table ciperpus.user: ~2 rows (approximately)
DELETE FROM `user`;
